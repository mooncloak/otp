...
fun MavenPublication.mavenCentralPom() {
    pom {
        name.set("otp")
        description.set("Kotlin multiplatform one time passwords implementation.")
        url.set("https://github.com/mooncloak/otp")
        ...
        developers {
            developer {
                ...
                roles.set(setOf("Primary otp developer. 💪"))
            }
        }

        scm {
            connection.set("https://github.com/mooncloak/otp.git")
            developerConnection.set("https://github.com/mooncloak/otp.git")
            url.set("https://github.com/mooncloak/otp")
        }
    }
}
